...
def train():
  ...
  train_step = tf.train.AdamOptimizer(learning_rate=1.0).minimize(loss)#, aggregation_method=tf.AggregationMethod.EXPERIMENTAL_ACCUMULATE_N, colocate_gradients_with_ops=True)
