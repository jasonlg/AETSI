...
[snr2, t_sp2, t_sa2, chimg2,tplimg2,meanSP2,meanSA2,meanSig2, k_ch2]=conv_LG_CHO_2d(saroi(:,:,id_sa_tr), sproi(:,:,id_sp_tr), saroi(:,:,id_sa_test), sproi(:,:,id_sp_test),0.75,15,1);                     
...
% sweep_limit = 30;
% temp = zeros(sweep_limit, 1);
% for i = 1:sweep_limit
%     [snr2, t_sp2, t_sa2, chimg2,tplimg2,meanSP2,meanSA2,meanSig2, k_ch2]=conv_LG_CHO_2d(saroi(:,:,id_sa_tr), sproi(:,:,id_sp_tr), saroi(:,:,id_sa_test), sproi(:,:,id_sp_test),i,5,1);
%     temp(i) = snr2;
% end
% 
% figure; plot(temp);